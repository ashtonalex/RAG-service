...
class EmbeddingPipeline:
    ...
    def search_similar_chunks(
        ...
        try:
            ...
            if (
                ...
                and isinstance(results.get("metadatas"), list)
    ...
    def get_collection_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"total_chunks": count, "collection_name": "documents"}
        except Exception as e:
...
async def embed_and_store_chunks(file_path: str, project_id: str, **kwargs):
    ...
    return await embedding_pipeline.embed_and_store_chunks(
        file_path, project_id, **kwargs
    )
