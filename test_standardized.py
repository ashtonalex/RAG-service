#!/usr/bin/env python3
"""
Standardized Test Script for RAG Pipeline
Tests all components with correct endpoints and consistent patterns
"""
...
TEST_PROJECT_NAME = "Standardized Test Project"

class RAGPipelineTester:
    """Standardized RAG Pipeline Tester"""
    ...
    async def test_chunking_endpoint(self, session):
        """Test the chunking endpoint directly"""
    ...
    async def run_comprehensive_test(self):
        """Run comprehensive standardized test"""
        print("🚀 Starting Standardized RAG Pipeline Test")
        print("=" * 60)
